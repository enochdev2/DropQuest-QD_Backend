...
export const deleteAnnouncement = async (req, res) => {
  ...
  try {
    ...
    const announcementDeleted = await announcementModel.findByIdAndDelete(announcementId)
    console.log("🚀 ~ deleteAnnouncement ~ announcementDeleted:", announcementDeleted)
